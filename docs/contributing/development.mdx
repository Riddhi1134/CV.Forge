...
<Steps>
  ...
  <Step title="Configure Environment Variables">
    ...
    # Database
    DATABASE_URL=postgresql://riddhi:riddhi1134@localhost:5432/reactiveresume
  ...
  <Step title="Run Database Migrations If Needed">
    ...
    ```bash
    DATABASE_URL="postgresql://riddhi:riddhi1134@localhost:5432/reactiveresume" pnpm run db:migrate
    ```
  </Step>
