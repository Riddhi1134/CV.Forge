...
// async function analyzeWithGroq(resumeData: unknown): Promise<AnalysisResult> {
...
//         {
//           role: "system",
//           content: "You are an expert ATS resume analyzer. Always respond with valid JSON only. No markdown, no code fences, no explanation.",
//         },
//         {
//           role: "user",
...
//     try {
//       const analysis = await analyzeWithGroq(resumeDetails.data);
//       setResult(analysis);
//     } catch (err) {
//       setError(
...
//           Analyze your resume for ATS compatibility using Gemini AI.
//         </p>
//       </div>
...
//                 Select a resume and click Scan to get AI-powered feedback.
//               </p>
...
//                     <span
//                       key={kw}
//                       className="rounded-full bg-green-500/10 px-2 py-0.5 text-green-600 text-xs font-medium"
//                     >
//                       {kw}
//                     </span>
//                   ))}
...
//                     <span
//                       key={kw}
//                       className="rounded-full bg-yellow-500/10 px-2 py-0.5 text-yellow-600 text-xs font-medium"
//                     >
//                       {kw}
//                     </span>
//                   ))}
...
//             </CardTitle>
//             <CardDescription>
//               AI-suggested improvements to boost your ATS score.
//             </CardDescription>
//           </CardHeader>
//           <CardContent>
